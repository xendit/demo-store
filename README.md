...
Mock store to demo implementation of Sessions Payment Links, Components and Legacy Payment Links

## Ownership
Team:  `xendit/merchant-interfaces` 

Slack Channel: `#wg-payment-interface`  

Slack Handle: `@munder-difflin`
